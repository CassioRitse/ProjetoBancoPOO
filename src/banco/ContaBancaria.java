...
public abstract class ContaBancaria {
    ...
    public String[] getArrayStringConta(){
        return new String[] {String.valueOf(this.numero),this.getClass().equals(ContaCorrente.class) ? "CC" : "CP", this.titular.getNome(), String.valueOf(this.saldo)};
    }
